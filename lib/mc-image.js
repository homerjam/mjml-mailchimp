...
var McImage = (_temp2 = _class = function (_MjImage) {
  ...
  return McImage;
}(_mjmlImage2.default), _class.componentName = 'mc-image', _class.endingTag = true, _class.allowedAttributes = (0, _extends3.default)({}, _mjmlImage2.default.allowedAttributes, {
  'mc:edit': 'string',
  'mc:hideable': 'string'
