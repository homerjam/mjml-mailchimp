...
(0, _mjmlValidator.registerDependencies)({
  'mj-column': ['mc-image-2x'],
  'mj-hero': ['mc-image-2x'],
  'mc-image-2x': []
});

var McImage2x = (_temp = _class = function (_MjImage) {
  (0, _inherits3.default)(McImage2x, _MjImage);

  function McImage2x() {
    (0, _classCallCheck3.default)(this, McImage2x);
    return (0, _possibleConstructorReturn3.default)(this, (McImage2x.__proto__ || (0, _getPrototypeOf2.default)(McImage2x)).apply(this, arguments));
  }

  (0, _createClass3.default)(McImage2x, [{
    key: 'renderImage',
    ...
    value: function renderImage() {
      ...
      var img = '\n      <span' + this.htmlAttributes({ 'mc:edit': this.getAttribute('mc:edit') }) + '><img\n        ' + this.htmlAttributes({
